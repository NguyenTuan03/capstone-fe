...
const STATS_DATA: Record<string, StatsCard[]> = {
  dashboard: [
    { title: 'Tổng số HLV', value: 2, subtitle: '1 đã được duyệt', icon: <TeamOutlined className="text-2xl" />, color: '#f5f5f5' },
    { title: 'HLV chờ duyệt', value: 1, subtitle: 'Cần kiểm duyệt', icon: <UserOutlined className="text-2xl" />, color: '#fff7e6', highlight: 1 },
    { title: 'Tổng nội dung', value: 5, subtitle: '2 đã được duyệt', icon: <FileTextOutlined className="text-2xl" />, color: '#f5f5f5' },
    { title: 'Nội dung chờ duyệt', value: 3, subtitle: 'Cần kiểm duyệt', icon: <ExclamationCircleOutlined className="text-2xl" />, color: '#fff7e6', highlight: 3 },
    { title: 'Tổng khóa học', value: 16, subtitle: '2 đã được duyệt', icon: <BookOutlined className="text-2xl" />, color: '#f5f5f5' },
    { title: 'Khóa học đang diễn ra', value: 6, subtitle: 'Đang hoạt động', icon: <PlayCircleOutlined className="text-2xl" />, color: '#e6f7ff', highlight: 6 },
  ],
  coaches: [
    { title: 'Tổng số HLV', value: 45, subtitle: '40 đang hoạt động', icon: <TeamOutlined className="text-2xl" />, color: '#f5f5f5' },
    { title: 'HLV chờ duyệt', value: 8, subtitle: 'Cần xác minh', icon: <UserOutlined className="text-2xl" />, color: '#fff7e6', highlight: 8 },
    { title: 'HLV đã xác minh', value: 35, subtitle: 'Đã được phê duyệt', icon: <TeamOutlined className="text-2xl" />, color: '#f5f5f5' },
    { title: 'HLV bị tạm ngưng', value: 2, subtitle: 'Cần xem xét', icon: <ExclamationCircleOutlined className="text-2xl" />, color: '#fff1f0', highlight: 2 },
    { title: 'Đánh giá trung bình', value: 4.8, subtitle: 'Trên 5.0 sao', icon: <TrophyOutlined className="text-2xl" />, color: '#f5f5f5' },
    { title: 'Tổng buổi học', value: 328, subtitle: 'Đã hoàn thành', icon: <BarChartOutlined className="text-2xl" />, color: '#e6f7ff', highlight: 328 },
  ],
  'course-verification': [
    { title: 'Tổng nội dung', value: 120, subtitle: 'Tất cả khóa học', icon: <FileTextOutlined className="text-2xl" />, color: '#f5f5f5' },
    { title: 'Chờ kiểm duyệt', value: 15, subtitle: 'Cần xem xét', icon: <ExclamationCircleOutlined className="text-2xl" />, color: '#fff7e6', highlight: 15 },
    { title: 'Đã phê duyệt', value: 95, subtitle: 'Đang hoạt động', icon: <FileTextOutlined className="text-2xl" />, color: '#f5f5f5' },
    { title: 'Bị từ chối', value: 10, subtitle: 'Cần chỉnh sửa', icon: <ExclamationCircleOutlined className="text-2xl" />, color: '#fff1f0', highlight: 10 },
    { title: 'Video bài giảng', value: 280, subtitle: 'Đã tải lên', icon: <PlayCircleOutlined className="text-2xl" />, color: '#e6f7ff' },
    { title: 'Tài liệu đính kèm', value: 156, subtitle: 'Files PDF/DOC', icon: <FileTextOutlined className="text-2xl" />, color: '#f5f5f5' },
  ],
  curriculum: [
    { title: 'Tổng khóa học', value: 45, subtitle: '40 đang mở', icon: <BookOutlined className="text-2xl" />, color: '#f5f5f5' },
    { title: 'Khóa học mới', value: 5, subtitle: 'Trong tháng này', icon: <BookOutlined className="text-2xl" />, color: '#fff7e6', highlight: 5 },
    { title: 'Tổng chương', value: 180, subtitle: 'Nội dung học', icon: <FileTextOutlined className="text-2xl" />, color: '#f5f5f5' },
    { title: 'Tổng bài học', value: 520, subtitle: 'Video và tài liệu', icon: <PlayCircleOutlined className="text-2xl" />, color: '#e6f7ff' },
    { title: 'Bài kiểm tra', value: 95, subtitle: 'Quiz và bài tập', icon: <FileTextOutlined className="text-2xl" />, color: '#f5f5f5' },
    { title: 'Học viên tham gia', value: 1250, subtitle: 'Đang học tập', icon: <UserOutlined className="text-2xl" />, color: '#f5f5f5' },
  ],
  users: [
    { title: 'Tổng người dùng', value: 2450, subtitle: '2100 đang hoạt động', icon: <UserOutlined className="text-2xl" />, color: '#f5f5f5' },
    { title: 'Người dùng mới', value: 125, subtitle: 'Tháng này', icon: <UserOutlined className="text-2xl" />, color: '#fff7e6', highlight: 125 },
    { title: 'Học viên', value: 2200, subtitle: 'Đang học tập', icon: <UserOutlined className="text-2xl" />, color: '#e6f7ff' },
    { title: 'Huấn luyện viên', value: 45, subtitle: 'Đang giảng dạy', icon: <TeamOutlined className="text-2xl" />, color: '#f5f5f5' },
    { title: 'Tài khoản bị khóa', value: 15, subtitle: 'Vi phạm quy định', icon: <ExclamationCircleOutlined className="text-2xl" />, color: '#fff1f0', highlight: 15 },
    { title: 'Đăng ký hôm nay', value: 8, subtitle: 'Người dùng mới', icon: <UserOutlined className="text-2xl" />, color: '#fff7e6', highlight: 8 },
  ],
  achievements: [
    { title: 'Tổng thành tựu', value: 48, subtitle: 'Đã tạo', icon: <TrophyOutlined className="text-2xl" />, color: '#f5f5f5' },
    { title: 'Thành tựu mới', value: 3, subtitle: 'Tháng này', icon: <TrophyOutlined className="text-2xl" />, color: '#fff7e6', highlight: 3 },
    { title: 'Đã mở khóa', value: 3520, subtitle: 'Lượt đạt được', icon: <TrophyOutlined className="text-2xl" />, color: '#e6f7ff' },
    { title: 'Thành tựu hiếm', value: 8, subtitle: 'Khó đạt được', icon: <TrophyOutlined className="text-2xl" />, color: '#fff1f0' },
    { title: 'Người hoàn thành nhiều nhất', value: 42, subtitle: 'Thành tựu cao nhất', icon: <UserOutlined className="text-2xl" />, color: '#f5f5f5' },
    { title: 'Đạt trong tuần', value: 156, subtitle: 'Lượt mở khóa', icon: <TrophyOutlined className="text-2xl" />, color: '#fff7e6', highlight: 156 },
  ],
  statistics: [
    { title: 'Doanh thu tháng', value: 125000000, subtitle: '+15% so với tháng trước', icon: <BarChartOutlined className="text-2xl" />, color: '#f5f5f5' },
    { title: 'Buổi học hoàn thành', value: 856, subtitle: 'Trong tháng', icon: <PlayCircleOutlined className="text-2xl" />, color: '#e6f7ff' },
    { title: 'Tỷ lệ hoàn thành', value: 87, subtitle: 'Phần trăm', icon: <BarChartOutlined className="text-2xl" />, color: '#f5f5f5' },
    { title: 'Đánh giá trung bình', value: 4.8, subtitle: 'Trên 5.0 sao', icon: <TrophyOutlined className="text-2xl" />, color: '#fff7e6' },
    { title: 'Người dùng hoạt động', value: 2100, subtitle: 'Trong 7 ngày', icon: <UserOutlined className="text-2xl" />, color: '#e6f7ff' },
    { title: 'Tăng trưởng', value: 22, subtitle: '% so với tháng trước', icon: <BarChartOutlined className="text-2xl" />, color: '#fff7e6', highlight: 22 },
  ],
};
  ...
  useEffect(() => {
    const loadCoachStats = async () => {
      try {
        ...
        const pendingCoaches = coachEntities.filter(c => c.verificationStatus === 'PENDING').length;
        const verifiedCoaches = coachEntities.filter(c => c.verificationStatus === 'VERIFIED').length;
        const rejectedCoaches = coachEntities.filter(c => c.verificationStatus === 'REJECTED').length;
    ...
    const loadAchievementStats = async () => {
      try {
        ...
        const propertyCheckAchievements = achievements.filter(a => a.type === 'PROPERTY_CHECK').length;
        const streakAchievements = achievements.filter(a => a.type === 'STREAK').length;
        
        const totalEarned = learnerAchievements.length;
        const totalInProgress = achievementProgresses.filter(ap => ap.currentProgress < 100).length;
